...
\monsterdetail{Souffle}{Cône de feu ou nuage de chlore gazeux de 27 m de long.
}
\monsterdetail{Langue et sorts}{100 \% ; 4 × 1er niveau, 4 × 2e niveau, 4 × 3e niveau.
}
\monsterdetail{Sommeil}{5 \%.
}
\monsterdetail{Changement de forme}{Peut prendre la forme d'une personne ou d'un animal.
}
...
\monsterattack{1 × morsure }{6d6)\] ou souffle}
\end{monster}
