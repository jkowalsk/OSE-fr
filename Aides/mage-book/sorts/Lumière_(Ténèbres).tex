...
\begin{enumerate}
\item
  \textbf{Invoquer une lumière magique} d'un rayon de 5 m. La lueur
...
créature de sa vue normale (mais pas d'une éventuelle infravision).
Ce sort peut servir à aveugler une créature ou à annuler le sort lumière.
}
\end{spell}
