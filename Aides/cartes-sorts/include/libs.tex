%   VORAUSGESETZTE LIBS
%   ------------------
\RequirePackage[usenames,dvipsnames,table]{xcolor} % required to avoid option clash in color and table
%   Ränder des Dokuments anpassen
\RequirePackage[margin=6mm,top=5mm]{geometry}
...
\RequirePackage[PGF,defaultunit=cm]{adjustbox}
